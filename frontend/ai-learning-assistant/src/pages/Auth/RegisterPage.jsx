                                          ...
                                          >
                                            <span className="relative z-10 flex items-center justify-center gap-2">
                                              {loading ? (
                                                ...
                                                <>
                                                Create Account
                                                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-tranfrom duration-200" 
                                                strokeWidth={2.5} 
                                                />
                                                </>
                                              )}
                                              </span>
                                              <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-while/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                                            </button>
                                            </div>
